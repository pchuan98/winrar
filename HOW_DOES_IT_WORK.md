...
2. Calculate $r$
    ...
    $$
    r = \left( (Rnd \cdot G)_x + h \right) \operatorname{Mod} n
    $$
...
\begin{aligned}
P &= (P_x, P_y) \\
P_x &= \texttt{0x3861220ed9b36c9753df09a159dfb148135d495db3af8373425ee9a28884ba1a},
\qquad P_x \in \mathrm{GF}\!\left((2^{15})^{17}\right) \\
P_y &= \texttt{0x12b64e62db43a56114554b0cbd573379338cea9124c8443c4f50e6c8b013ec20},
\qquad P_y \in \mathrm{GF}\!\left((2^{15})^{17}\right)
\end{aligned}
\]
